SELECT  aws_cloudtrail_trails.account_id
...
JOIN aws_cloudwatch_alarms
ON aws_cloudwatch_alarm_metrics.alarm_id = aws_cloudwatch_alarms.id
JOIN aws_sns_subscriptions
ON aws_sns_subscriptions.topic_arn = ANY (aws_cloudwatch_alarms.alarm_actions)
